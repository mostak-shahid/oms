                    ...
                    <div class="card-body">
                        <div class="form-horizontal">
                            <form action="" class="validate">
                                ...
                                <div class="form-group row">
                                    <label for="timezone_string" class="col-sm-2 col-form-label">Timezone</label>
                                    <div class="col-sm-10">
                                        <select id="timezone_string" name="timezone_string" class="form-control select2bs4" style="width: 100%;">
